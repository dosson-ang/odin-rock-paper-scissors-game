...
function playGame() {
  ...
  if (humanScore > computerScore) {
    ...
    console.log(`The final standings are ${humanScore} - ${computerScore}! The computer wins the game! Better luck next time!`);
  } else {
    console.log(`The final standings are ${humanScore} - ${computerScore}! It's a tie!`);
  }
}
